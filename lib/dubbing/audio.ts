...
// Re-exported for backward compatibility — this constant now lives in ./timeline
// (which, unlike this file, is safe to import from client components too).
export { DEFAULT_DUB_SAMPLE_RATE } from './timeline';
export type { ParsedWav } from './timeline';
