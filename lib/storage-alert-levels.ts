...
// 3 niveles escalonados de aviso a medida que un bucket se acerca a su límite.
export const STORAGE_ALERT_LEVELS: StorageAlertLevel[] = [
  { threshold: 75, label: 'Aviso', emoji: '⚠️', color: '#f59e0b' },
  { threshold: 90, label: 'Advertencia crítica', emoji: '🟠', color: '#f97316' },
  { threshold: 98, label: 'Urgente', emoji: '🔴', color: '#ef4444' },
];
